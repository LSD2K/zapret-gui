...
def build_fakeip_config(*, proxy_outbound: dict,
                        ...
                        dns_port: int = None,
                        front_dns: str = "engine", **front_kw) -> dict:
    """
    ...
    """
    if front_dns != "engine":
        from core.singbox_fakeip_front import build_config_hook
        return build_config_hook(
            front_dns, proxy_outbound=proxy_outbound, direct_dns=direct_dns,
