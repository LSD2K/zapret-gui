...
«сервер → клиент»: на legacy-SSE и на stdio-мосте (поток-писатель
`stdio._Notifier` со своей сессией вне общего реестра и замком на
stdout). Период опроса задаёт сам
