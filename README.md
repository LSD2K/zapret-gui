...
114 инструментов. Что из них видно клиенту — решают разрешения:
невыданное не просто запрещено, оно **не публикуется**, и модель о нём
не знает.

**Чтение — всегда, отдельного разрешения нет** (35):
...
**`strategies_write` — стратегии и списки** (11): `strategy_save`,
